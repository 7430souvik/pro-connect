...
import { getAllPosts, deletePost, incrementPostLike, getAllComments, postComment} from '@/config/redux/action/postAction';
...
export default function Dashboard() {
    ...
    useEffect(() => {
        ...
        console.log("isTokenThere:", authState.isTokenThere);
            ...
            <div className={styles.scrollComponent}>
                ...
                <div className={styles.wrapper}>
                    ...
                    <div className={styles.createPostContainer}>
                        ...
                        <textarea onChange={(e)=> setPostContent(e.target.value)}  value={postContent} placeholder={"what's in  your mind?"}  className={styles.textArea} id=""></textarea>
