...
const convertUserDataTOPDF = async (userData)=>{
    ...
    doc.image(`uploads/${userData.userId.profilePicture}`, {align: "center", width:1000});
...
export const register = async(req,res)=>{
    try{
        ...
        if(! name|| ! email|| !password || !username) return res.status(400).json({message:"All files are required"})
